 ...
 * @author ASUS
 */
public class DaftarjudulAcc extends javax.swing.JFrame {

    /**
     * Creates new form DaftarjudulAcc
     */
    public DaftarjudulAcc() {
    ...
    private void loadDataDisetujui() {
    ...
    try {
        ...
        String sql = "SELECT judul_id, judul, status FROM judulskripsi WHERE status = 'Disetujui'";
        ...
        tableJudulAcc.setModel(model); // ganti dengan nama tabel di form kamu
    ...
    private void initComponents() {
        ...
        tableJudulAcc = new javax.swing.JTable();
        ...
        jLabel1.setText("DAFTAR JUDUL DI SETUJUI");

        tableJudulAcc.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tableJudulAcc);
    ...
    private void btnLihatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLihatActionPerformed
        int selectedRow = tableJudulAcc.getSelectedRow();
        if (selectedRow == -1) {
        ...
        // Simpan ke session
        Session.judul_id = (int) tableJudulAcc.getValueAt(selectedRow, 0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DaftarjudulAcc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tableJudulAcc;
